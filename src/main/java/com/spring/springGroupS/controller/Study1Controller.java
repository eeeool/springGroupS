...
//@RequestMapping(value = "/mapping/test31", method = RequestMethod.POST)
	...
	public String test33Post(Model model, HoewonVO vo) {
		...
		// 회원가입 후 메세지 처리한다.
		model.addAttribute("message", vo.getMid() + "님 회원가입 되었습니다.");
...
//		vo.setMid(mid);
	...
	public String test35Post(Model model, HoewonVO vo) {
		// 회원 아이디의 첫글자가 'a'로 시작하는 회원만 가입처리하도록 한다.
	...
	public String aopMenuGet() {
		log.info("study1컨트롤러의 aopMenu 메소드입니다.");
	...
	public String aopTest1Get() {
		log.info("study1컨트롤러의 test1 메소드입니다.");
...
//		service.getAopServiceTest1();
	...
	public String aopTest2Get() {
		log.info("study1컨트롤러의 test2 메소드입니다.");
	...
	public String aopTest3Get() {
		log.info("study1컨트롤러의 test3 메소드입니다.");
	...
	public String aopTest4Get() {
		log.info("study1컨트롤러의 test4 메소드입니다.");
...
//		
//		SungjukVO vo3 = context.getBean("vo2", SungjukVO.class);
