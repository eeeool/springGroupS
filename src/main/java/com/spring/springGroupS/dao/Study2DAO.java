...
public interface Study2DAO {
	...
	void setDeleteCrimeCheckPost(@Param("year") int year);
	...
	int kakaoAddressDeletePost(@Param("address") String address);

	String setQrCodeCreate(@Param("realPath") String realPath, @Param("vo") QrCodeVO vo);

	void setQrCodeCreate(@Param("vo") QrCodeVO vo);

	QrCodeVO getQrCodeSearch(@Param("vo") String qrCode);
}
