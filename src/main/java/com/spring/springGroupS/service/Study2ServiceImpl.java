...
public class Study2ServiceImpl implements Study2Service {
	...
	public void getCalendar() {
		...
		int startWeek = calView.get(Calendar.DAY_OF_WEEK); // 해당 년월일의 요일값을 가져온다. 
	...
	@Override
	public void setDeleteCrimeCheckPost(int year) {
		study2DAO.setDeleteCrimeCheckPost(year);
	}
	...
	public int kakaoAddressDeletePost(String address) {
		return study2DAO.kakaoAddressDeletePost(address);
	}
