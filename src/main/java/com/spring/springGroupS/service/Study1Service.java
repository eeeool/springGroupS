...
public class Study1Service {
	...
	public void getAopServiceTest3() {
		...
		log.info("getAopServiceTest3 메소드(while문)0~100: "+tot+"\n");
	}
	public void getAopServiceTest4() {
		log.info("getAopServiceTest4 메소드입니다\n");
		...
		log.info("getAopServiceTest4 메소드(while문)0~100: "+tot+"\n");
	}
...
//		return tot;
	...
	public void getAopServiceTest53() {
		...
		log.info("getAopServiceTest53 메소드(while문)0~100: "+tot+"\n");
	}
	
	public void getAopServiceTest54() {
		log.info("getAopServiceTest54 메소드입니다\n");
		...
		log.info("getAopServiceTest54 메소드(while문)0~100: "+tot+"\n");
	}
}
