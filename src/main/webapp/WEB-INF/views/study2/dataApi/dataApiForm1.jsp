...
<head>
	...
	<script>
		...
		const API_KEY = 'MzPCcIuixfb2xiau%2FEQSVlTRqdiGYIHEdOhzNTKeLjfrpCa4nJOOcwfVXvUfdUn2S1OTn95ZinfT50Z6DIU5YA%3D%3D';
		...
		async function crimeCheck() {
			...
			else if (year == 2019) apiYear = '/15084592/v1/uddi:2d687e27-b5c3-4bdb-9b77-c644dcafcbc7';
			...
			url += apiYear + '?serviceKey=' + API_KEY + '&page=1&perPage=200';
		...
		function deleteCrimeCheck() {
			...
			$.ajax({
				...
				type: 'post',
				data: { year: year },
				success: () => alert(year + '년도 자료가 삭제되었습니다.'),
				error: () => alert('전송 오류')
			});
		}
...
<div class="container">
  ...
  <form name="police	Form" method="post">
