...
select * from review v, reviewReply r
where part='pds' and v.partIdx=4 and v.idx=r.reviewIdx;

select * from (select * from review where partIdx=4) v left join reviewReply r on part='pds' 
and v.partIdx=4 and v.idx=r.reviewIdx;