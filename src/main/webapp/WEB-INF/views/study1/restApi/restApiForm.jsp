...
<div class="container">
	...
	<div>
		...
		<a href="${ctp}/restApi/restApi1/Hello SpringFramework3" class="btn btn-info me-3">호출3</a>
		<a href="${ctp}/restApi/restApi2/Hello" class="btn btn-secondary me-3">호출4(RestController-객체)</a>
	</div>
	<hr/>
	공공데이터를 활용한 예제?
	<hr/>
