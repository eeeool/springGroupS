...
<div class="container">
	...
	<pre>
		...
		<hr/>
		<font size="5"><b>BCyptPasswordEncoder</b></font>
	...
	<div class="input-group mb-3">
		<input type="password" name="pwd" id="pwd" value="qwer1234!!" autofocus required />
	...
	<div>
		...
		<input type="button" value="ARIA" onclick="AriaCheck()" class="btn btn-warning me-2" />
		<input type="button" value="BCryptPasswordEncoder" onclick="BCyptPasswordEncoder()" class="btn btn-primary me-2" />
	</div>
	<hr/>
	출력결과: <br/>
	<div id="demo"></div>
