    	...
    	$.ajax({
    		...
    		success: (res) => {
    			if (res != 0) {
    				...
    				swal.fire('파일삭제 실패', '', 'error');
    			}
    		},
    		error: () => swal.fire('전송 오류', '', 'warning')
    	});
...
<div class="container">
  ...
  <div>
  	<div class="col"><a href="multiFileUpload" class="btn btn-success">멀티파일 업로드 이동</a></div>
  </div>
  	...
  	<table class="table table-hover text-center">
  		...
  		<c:forEach var="file" items="${files}" varStatus="st">
  			<tr>
  				...
  				<td>
  					<input type="button" value="삭제" onclick="fileDalete('${file}')" class="btn btn-danger btn-sm" />
  				</td>
  			</tr>
  		</c:forEach>
  	</table>
