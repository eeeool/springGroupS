...
<div class="container">
	...
	<hr/>
	<div>기본값 전달: <br/>
		<a href="javascript:ajaxTest1(10)" class="btn btn-secondary me-2 mb-2">값(숫자) 전달1(일반)</a>
		<a href="javascript:ajaxTest2(10)" class="btn btn-success me-2 mb-2">값(숫자) 전달2</a>
		<a href="javascript:ajaxTest3('atom')" class="btn btn-primary me-2 mb-2">값(숫자) 전달3</a>
	</div>
	<hr/>
	<div>객체전달: <br/>
		<a href="ajaxObjectForm" class="btn btn-primary me-2 mb-2">객체전달 연습</a>
	</div>
	<hr/>
	<div id="demo1"></div>
</div>
