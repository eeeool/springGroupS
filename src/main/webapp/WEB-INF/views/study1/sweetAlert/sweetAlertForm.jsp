    ...
    */
    ...
    $(function() {
    	...
    	$('#image1').click(() => {
    		swal.fire({
    			title: '1. 그림 연습',
    			imageUrl: 'https://cdn.pixabay.com/objects3d/2025/07/11/04-16-02-377/render_720_720_0_340_0.png',
    			imagAlt: '하트'
    		})
    	});
    	...
    	$('#html1').click(() => {
    		swal.fire({
    			...
    			html: `
    				...
    				<a href="https://daum.net" class="btn btn-success btn-sm">다음</a> 방문하기
    			`
    		})
    	});
    });
...
<div class="container">
  ...
  <hr class="border-1 border-dark">
 	<div>
  	...
  	<button type="button" id="image1" class="btn btn-outline-info">image1</button>
  	<button type="button" id="image2" class="btn btn-outline-primary">image2</button>
