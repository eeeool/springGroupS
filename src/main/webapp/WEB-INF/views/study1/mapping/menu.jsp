...
<div class="container">
  ...
  <p>
    ...
    <a href="test4?mid=snm1234&pwd=8765&sex=1" class="btn btn-info">test4</a>
    <a href="test5?mid=snm1234&pwd=8765&name=소나무&gender=남자&age=20" class="btn btn-dark">test5</a>
  </p>
  <p>
    <a href="test6?mid=ohn1234&pwd=1357&name=오하늘&gender=여자&age=20" class="btn btn-outline-success">test6</a>
    <a href="test7?mid=gid1234&pwd=2468&name=고인돌&gender=여자&age=20" class="btn btn-outline-primary">test7</a>
    <a href="test8?mid=atom1234&pwd=0987&name=아톰&gender=중성&age=12" class="btn btn-outline-secondary">test8</a>
    <a href="test9?mid=atom1234&pwd=5678&name=비톰&gender=남자&age=44" class="btn btn-outline-info">test9</a>
  </p>
  ...
  <p>
  	...
  	<a href="2468/______/test24/ohn1234" class="btn btn-info">test24</a>
  	<a href="test25//atom1234/5678/비톰/_____/남자/44" class="btn btn-outline-dark">test25</a>
  </p>
