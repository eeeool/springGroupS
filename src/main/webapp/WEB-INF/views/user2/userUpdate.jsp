...
<div class="container">
  ...
  <table class="table table-bordered">
    <tr>
      <th>아이디</th>
      <td><input type="text" name="mid" id="mid" value="${vo.mid}" class="form-control" autofocus required readonly /></td>
    </tr>
    <tr>
      <th>성명</th>
    ...
    <tr>
      <th>나이</th>
      <td><input type="number" name="age" id="age" value="20" value="${vo.age}" class="form-control" /></td>
    </tr>
    <tr>
      <th>주소</th>
    ...
    <tr>
      <td colspan="2" class="text-center">
        <input type="submit" value="회원정보 수정" class="btn btn-success" />
