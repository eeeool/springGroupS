...
<head>
	...
	<script>
		...
		//조건: 아이디 검색시 검색한 아이디가 없으면 본문 리스트에는 '검색한 아이디가 없습니다.'로 출력
...
<div class="container">
	...
	<div>
		<a href="userInput" class="btn btn-success btn-sm m-2">User 등록</a>
	</div>
	<table class="table table-hover text-center">
		...
		<c:if test="${fn:length(vos) == 0}">
			<tr>
				<td colspan="6" class="text-center">검색한 <font color="red"><b>${mid}</b></font>가 없습니다.</td>
			</tr>
		</c:if>
	</table>
	<hr/>
